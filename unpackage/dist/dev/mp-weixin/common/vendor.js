...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"SBTI人格测试","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 30 */
/*!*****************************************!*\
  !*** /Users/mao/sbti-uniapp/pages.json ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 51 */
/*!*************************************************!*\
  !*** /Users/mao/sbti-uniapp/utils/questions.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.specialQuestions = exports.questions = exports.dimensions = void 0;
// SBTI 人格测试题目
var questions = [{
  id: 'q1',
  dim: 'S1',
...
// 维度说明
exports.specialQuestions = specialQuestions;
var dimensions = {
  S1: {
    name: '自我认知',
    low: '自卑',
...
/* 52 */
/*!**************************************************!*\
  !*** /Users/mao/sbti-uniapp/utils/calculator.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _personalities = __webpack_require__(/*! ./personalities.js */ 53);
// 计算人格类型
...
function calculateDimensionScores(answers, questions) {
  ...
  questions.forEach(function (q) {
    if (answers[q.id] !== undefined && q.dim) {
      var dim = q.dim.replace(/[0-9]/g, ''); // 移除数字，获取维度字母
      if (!scores[dim]) {
        scores[dim] = 0;
        counts[dim] = 0;
      }
...
function calculatePersonality(answers, questions) {
  var scores = calculateDimensionScores(answers, questions);

  // 检查是否有饮酒爱好
  if (answers['drink_gate_q1'] === 3 && answers['drink_gate_q2'] === 2) {
    return {
      type: _personalities.personalityTypes.RUNK,
      scores: scores,
      badge: '酒精考验',
  ...
  // 统计各人格类型的得分
  var typeScores = {};
  Object.keys(_personalities.personalityTypes).forEach(function (code) {
    typeScores[code] = 0;
  });

  // 根据维度规则累加得分
  Object.keys(levels).forEach(function (dim) {
    var _dimensionRules$dim;
    var level = levels[dim];
    var types = ((_dimensionRules$dim = dimensionRules[dim]) === null || _dimensionRules$dim === void 0 ? void 0 : _dimensionRules$dim[level]) || [];
    types.forEach(function (code, index) {
  ...
  // 找出得分最高的人格类型
  var maxScore = 0;
  var resultType = _personalities.personalityTypes.IMSB;
  Object.keys(typeScores).forEach(function (code) {
    if (typeScores[code] > maxScore) {
      maxScore = typeScores[code];
      resultType = _personalities.personalityTypes[code];
    }
  });

  // 生成徽章和提示语
  var badge = generateBadge(resultType.code, scores);
  var modeKicker = generateModeKicker(resultType.code);
  return {
    type: resultType,
    scores: scores,
    badge: badge,
...
/* 53 */
/*!*****************************************************!*\
  !*** /Users/mao/sbti-uniapp/utils/personalities.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.personalityTypes = exports.personalityList = void 0;
// SBTI 人格类型定义
...
var personalityList = Object.values(personalityTypes);
exports.personalityList = personalityList;

...
export const dimensions = {
  S1: { name: '自我认知', low: '自卑', high: '自信' },
  S2: { name: '内在追求', low: '迷茫', high: '明确' },
  S3: { name: '成就动机', low: '佛系', high: '进取' },
  E1: { name: '依恋安全', low: '焦虑', high: '安全' },
  E2: { name: '情感投入', low: '疏离', high: '投入' },
  E3: { name: '亲密边界', low: '融合', high: '独立' },
  A1: { name: '信任他人', low: '怀疑', high: '信任' },
  A2: { name: '规则遵守', low: '叛逆', high: '顺从' },
  A3: { name: '意义感', low: '虚无', high: '充实' },
  Ac1: { name: '目标导向', low: '回避', high: '进取' },
  Ac2: { name: '决策风格', low: '犹豫', high: '果断' },
  Ac3: { name: '执行力', low: '拖延', high: '高效' },
  So1: { name: '社交主动性', low: '被动', high: '主动' },
  So2: { name: '社交边界', low: '开放', high: '封闭' },
  So3: { name: '社交面具', low: '真实', high: '伪装' }
}
